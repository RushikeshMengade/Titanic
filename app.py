...
app=Flask(__name__)
model=pickle.load(open("titanic_dataset_deploy.pkl","rb"))
...
def predict():
    if request.method == "POST":
        ...
        if output == 1:
            return render_template('index2.html',prediction_text=f" Congratulations !!You could have saved!!")
        else:
            return render_template('index2.html',prediction_text=f"Sorry!! You could not have saved!! ")
